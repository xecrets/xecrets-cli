...
<a name='Xecrets.Sdk.XfApiFactory.XfApiFactory(string,System.Func_bool_,string,string,ReactiveUI.Primitives.Concurrency.ISequencer,ReactiveUI.Primitives.Concurrency.ISequencer)'></a>

## XfApiFactory(string, Func<bool>, string, string, ISequencer, ISequencer) Constructor

Create an [IXfApi](Xecrets.Sdk.Abstractions.md#Xecrets.Sdk.Abstractions.IXfApi 'Xecrets.Sdk.Abstractions.IXfApi') instance.

```csharp
public XfApiFactory(string license, System.Func<bool> debugCli, string workFolder, string crashLogName, ReactiveUI.Primitives.Concurrency.ISequencer taskpoolScheduler, ReactiveUI.Primitives.Concurrency.ISequencer mainthreadScheduler);
```
#### Parameters

<a name='Xecrets.Sdk.XfApiFactory.XfApiFactory(string,System.Func_bool_,string,string,ReactiveUI.Primitives.Concurrency.ISequencer,ReactiveUI.Primitives.Concurrency.ISequencer).license'></a>
...
<a name='Xecrets.Sdk.XfApiFactory.XfApiFactory(string,System.Func_bool_,string,string,ReactiveUI.Primitives.Concurrency.ISequencer,ReactiveUI.Primitives.Concurrency.ISequencer).debugCli'></a>

`debugCli` [System.Func&lt;](https://learn.microsoft.com/en-us/dotnet/api/system.func-1 'System.Func`1')[System.Boolean](https://learn.microsoft.com/en-us/dotnet/api/system.boolean 'System.Boolean')[&gt;](https://learn.microsoft.com/en-us/dotnet/api/system.func-1 'System.Func`1')
...
<a name='Xecrets.Sdk.XfApiFactory.XfApiFactory(string,System.Func_bool_,string,string,ReactiveUI.Primitives.Concurrency.ISequencer,ReactiveUI.Primitives.Concurrency.ISequencer).workFolder'></a>
...
<a name='Xecrets.Sdk.XfApiFactory.XfApiFactory(string,System.Func_bool_,string,string,ReactiveUI.Primitives.Concurrency.ISequencer,ReactiveUI.Primitives.Concurrency.ISequencer).crashLogName'></a>
...
<a name='Xecrets.Sdk.XfApiFactory.XfApiFactory(string,System.Func_bool_,string,string,ReactiveUI.Primitives.Concurrency.ISequencer,ReactiveUI.Primitives.Concurrency.ISequencer).taskpoolScheduler'></a>

`taskpoolScheduler` [ReactiveUI.Primitives.Concurrency.ISequencer](https://learn.microsoft.com/en-us/dotnet/api/reactiveui.primitives.concurrency.isequencer 'ReactiveUI.Primitives.Concurrency.ISequencer')

An [ReactiveUI.Primitives.Concurrency.ISequencer](https://learn.microsoft.com/en-us/dotnet/api/reactiveui.primitives.concurrency.isequencer 'ReactiveUI.Primitives.Concurrency.ISequencer') instance to schedule work on the
            taskpool.

<a name='Xecrets.Sdk.XfApiFactory.XfApiFactory(string,System.Func_bool_,string,string,ReactiveUI.Primitives.Concurrency.ISequencer,ReactiveUI.Primitives.Concurrency.ISequencer).mainthreadScheduler'></a>

`mainthreadScheduler` [ReactiveUI.Primitives.Concurrency.ISequencer](https://learn.microsoft.com/en-us/dotnet/api/reactiveui.primitives.concurrency.isequencer 'ReactiveUI.Primitives.Concurrency.ISequencer')

An [ReactiveUI.Primitives.Concurrency.ISequencer](https://learn.microsoft.com/en-us/dotnet/api/reactiveui.primitives.concurrency.isequencer 'ReactiveUI.Primitives.Concurrency.ISequencer') instance to schedule work on the main (GUI)
            thread.
### Methods
