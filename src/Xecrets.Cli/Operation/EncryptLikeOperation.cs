...
internal class EncryptLikeOperation : IExecutionPhases
{
    ...
    public Task<Status> RealAsync(Parameters parameters)
    {
        ...
        using Decryption decryption = new(fromStore.OpenRead(), parameters.Identities, new NoProgressContext());
        
        parameters.EncryptLikeCredentials = decryption.ExtractEncryptionCredentials();
