...
internal abstract class RunFactory(Parameters parameters)
{
    readonly Dictionary<XfOpCode, Func<IExecutionPhases>> _operationTable = new()
    {
        ...
        { XfOpCode.LoadPrivateKeys, () => new LoadPrivateKeysOperation() },
        { XfOpCode.LoadPublicKeys, () => new LoadPublicKeysOperation() },
        ...
        { XfOpCode.Slip39Combine, () => new Slip39CombineOperation() },
        { XfOpCode.Slip39Group, () => new Slip39GroupOperation() },
        { XfOpCode.Slip39GroupThreshold, () => new Slip39GroupThresholdOperation() },
        { XfOpCode.Slip39Password, () => new Slip39PasswordOperation() },
        { XfOpCode.Slip39Secret, () => new Slip39SecretOperation() },
        { XfOpCode.Slip39Shares, () => new Slip39SharesOperation() },
        { XfOpCode.Slip39Split, () => new Slip39SplitOperation() },
        { XfOpCode.Slip39Information, () => new Slip39InformationOperation() },
