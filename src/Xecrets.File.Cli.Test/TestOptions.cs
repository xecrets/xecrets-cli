...
namespace Xecrets.File.Cli.Test
{
    [TestFixture]
    internal class TestOptions
    {
        ...
        {
            var parser = new OptionsParser("XecretsFileCli --password secretStuff --encrypt-to from.txt to.axx");
        ...
        {
            var parser = new OptionsParser("XecretsFileCli --unknown blabla");
        ...
        {
            var parser = new OptionsParser("XecretsFileCli --password secretStuff moreStuff --encrypt-to from.txt to.axx");
            Assert.That(parser.ParseStatus.StatusCode, Is.EqualTo(XfStatusCode.ExtraArguments));
        }
        ...
        public void TestQuiet()
        {
            ...
            parser = new OptionsParser("XecretsFileCli --quiet");
            Assert.That(parser.ParseStatus.IsSuccess);
        ...
        public void TestUnknownOption()
        {
            ...
            parser = new OptionsParser("XecretsFileCli --password a --text-log --environment AVALUE big.axx");
